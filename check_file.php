...
-если в логе нет ETag найденного или не совпал->
    чтение, запись на диск и в лог event="record" внести ключи 4,5,7
иначе запись в лог event="unchanged" с указанием 4,5,7;
...
8 => Accept-Ranges: bytes
 -->
//Рабочая ветка по индексам
 // if ((string) $this->xml_content->year[-1]['current_year'] != '2021') {//FIXME:date('Y')
        //     echo "<p><u>Проверка года выполнена</u></p>";
